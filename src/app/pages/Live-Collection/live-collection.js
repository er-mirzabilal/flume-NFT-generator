    ...
    return (
      <>
        <section>
          <div class="max-w-screen-2xl w-11/12 mx-auto">
            ...
            <div class="flex lg:flex-row flex-col p-10 shadow-lg rounded-lg">
              <div class="md:ml-5">
                <h4>
                  Past the Flume script in the {"<head>"} of every page you wish
                  to enable minting button and use{" "}
                  <strong>onclick="javascript:mint()"</strong> funtion in your
                  cusomized minting button{" "}
                </h4>
              ...
              <div class="flex justify-between flex-grow">
                ...
                >
                  <button
                    ...
                    class="p-2 m-2 flex-grow flex border-1 rounded-lg border-gray bg-gray justify-evenly items-center"
                  >
                    <span class="px-2">Smart Contract Source Code</span>{" "}
                    <ArrowRight />
                  </button>
                </a>
              </div>
        ...
        {collection?.status === collectionStatus.PINNING ? (
          <section>
            <div class="max-w-screen-2xl w-11/12 mx-auto mb-16">
              <h2 class="text-2xl font-medium my-8">
                Files synchronization with IPFS
              </h2>
          ...
          <section>
            <div class="max-w-screen-2xl w-11/12 mx-auto mb-16">
              ...
              <div class="p-10 shadow-lg rounded-lg">
                <p class="m-2 text-lg">
                  Files are synchronized <CheckCircleIcon color="primary" />
                </p>
              </div>
            </div>
          </section>
