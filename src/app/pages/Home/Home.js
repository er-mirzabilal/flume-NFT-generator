    ...
    <div>
      ...
      <section class="text-gray-600 body-font">
        <div class="max-w-screen-2xl mx-auto flex sm:flex-nowrap flex-wrap">
          <div class="pl-6 pr-6 sm:pr-10 md:pl-16 sm:py-0 py-10 self-center">
            <h2 class="title-font xl:text-6xl lg:text-5xl md:text-4xl text-3xl lg:mb-4 mb-1 font-medium text-third">
              Create and Deploy NFT Collections without coding
            </h2>
            <p className="mb-3 text-xl text-third sm:text-md md:text-xl lg:mb-5">
              Generate, deploy, and trade NFT collections without writing any
              line of code. All in a matter of minutes!
            </p>
            <div class="flex no-wrap">
              <a href="#">
                <button class="m-1 text-white bg-primary border-0 py-2 sm:px-6 px-2 focus:outline-primary rounded sm:text-lg text-md">
                  Join the Discord
                </button>
              </a>
              <a href="/create-collections">
                <button class="m-1 text-white bg-secondary border-0 py-2 sm:px-6 px-2 focus:outline-secondary rounded sm:text-lg text-md">
                  Generate Collection
                </button>
              </a>
            </div>
      ...
      <section class="text-gray-600 bg-gray body-font">
        <div class="max-w-screen-2xl w-11/12 mx-auto flex sm:flex-nowrap flex-wrap-reverse">
          ...
          <div class="mt-6 lg:mt-0 pl-0 sm:pl-6 text-left self-center">
            <h2 class="text-md md:text-xl title-font text-primary">Easy</h2>
            <hr class="w-6 mb-3 font-xl border-primary" />
            <h1 class="text-third xl:text-6xl lg:text-5xl md:text-4xl text-3xl mb-3">
              The simplest way to{" "}
              <span class="text-secondary">
                {" "}
                generate and deploy NFT collections
              </span>{" "}
              on the blockchain
            </h1>

            <p class="text-third text-xl sm:text-md md:text-xl mb-3">
              No coding required, at all. Create your layers, import your
              assets, click Generate and you are done!
            </p>
            <a
              href="https://docs-flume.gitbook.io/flume/what-is-flume/general-flow"
              target="_blank"
            >
              <button class="flex text-white bg-primary border-0 py-2 focus:outline-primary rounded sm:text-lg text-md sm:px-6 px-2">
                Learn More
              </button>
            </a>
          </div>
      ...
      <section class="text-gray-600 body-font">
        <div class="max-w-screen-2xl w-11/12 mx-auto flex sm:flex-nowrap flex-wrap">
          <div class="mt-6 lg:mt-0 pr-0 sm:pr-6 text-left self-center">
            <h2 class="text-md md:text-xl title-font text-primary">
              Integrated
            </h2>
            <hr class="w-6 mb-3 font-xl border-primary" />
            <h1 class="text-third xl:text-6xl lg:text-5xl md:text-4xl text-3xl mb-3">
            ...
            <a
              ...
              target="_blank"
            >
              <button className="flex px-2 py-2 text-white border-0 rounded bg-primary focus:outline-primary sm:text-lg text-md sm:px-6">
                Learn More
              </button>
            </a>
          </div>
      ...
      <section class="text-gray-600 body-font">
        <div class="max-w-screen-2xl w-11/12 mx-auto flex sm:flex-nowrap flex-wrap-reverse">
          ...
          <div class="mt-6 lg:mt-0 pl-0 sm:pl-6 text-left self-center">
            ...
            <h1 class="text-third xl:text-6xl lg:text-5xl md:text-4xl text-3xl mb-3">
              Configure Rarity,{" "}
              <span class="text-secondary">Mint Price and Deploy</span> to
              Blockchain
            </h1>

            <p class="text-third text-xl sm:text-md md:text-xl mb-3">
              Configure certain attributes to be more rare than others, set the
              minting price and deploy your collection to the blockchain.
            </p>
            <a
      ...
      <section class="text-gray-600 body-font">
        <div class="max-w-screen-2xl w-11/12 mx-auto flex sm:flex-nowrap flex-wrap">
          <div class="mt-6 lg:mt-0 pr-0 sm:pr-6 text-left self-center">
            ...
            <hr class="w-6 mb-3 font-xl border-primary" />
            <h1 class="text-third xl:text-6xl lg:text-5xl md:text-4xl text-3xl mb-3">
              <span class="text-secondary"> Ready-made </span> Minting Button
            </h1>

            <p class="text-third text-xl sm:text-md md:text-xl mb-3">
              Embed a minting button linked to your collection to any website.
              Customize it as you want and allow people to mint directly from
              there.
            </p>
            <a
